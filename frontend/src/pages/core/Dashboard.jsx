...
export const Dashboard = () => {
  ...
  // Fetch AI recommendations - cache for 10 minutes (Option B)
        ...
        <div className="flex gap-3 items-center">
          ...
          <div>
            ...
            <p className="text-xs text-muted max-w-xl animate-fade-in">
              {recommendations?.briefing || "Arsenal takes on Manchester City today in the match of the season. Haaland leads goals with 28. Real Madrid closes in on Zubimendi."}
            </p>
          </div>
        </div>
        <Button
                ...
                <div className="flex flex-wrap gap-2 pt-1.5">
                  ...
                  {recommendations.suggestedPrompts.map((promptText, index) => (
                    <button
                      ...
                      className="text-[10px] bg-background hover:bg-primary/5 hover:border-primary/30 border border-border rounded-full px-3 py-1 text-muted hover:text-primary transition-all cursor-pointer font-medium"
                    >
                      {promptText}
                    </button>
                  ))}
